...
TEST_CASE("Filter lines correctly", "[pre_processor]"){
    ...
    Pre_processor proc("assets/pre_processor/test_filter_lines.txt");
    std::ifstream test_file("assets/pre_processor/test_filter_lines.txt");
...
TEST_CASE("Testing detection of lexical errors", "[error]"){
    Pre_processor proc("assets/pre_processor/test_filter_lines_error.txt");
    proc.run();
